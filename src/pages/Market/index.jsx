...
const MarketPage = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 flex sm:flex-col md:flex-col flex-row font-outfit sm:gap-5 md:gap-5 items-start mx-auto pb-[50px] w-full">
          ...
          <div className="flex flex-col font-urbanist gap-[21px] items-start justify-start w-[95%] md:w-full">
            ...
            <div className="flex flex-col items-center justify-start ml-0.5 md:ml-[0] w-full">
              <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start w-full">
                ...
                <Button
                  className="cursor-pointer flex items-center justify-center min-w-[151px] sm:ml-[0] ml-[447px]"
                  leftIcon={
                    <Img
              ...
              <Button
                className="cursor-pointer font-medium min-w-[106px] mt-[50px] text-center text-gray_900 text-sm tracking-[0.14px]"
                shape="RoundedBorder10"
                size="sm"
