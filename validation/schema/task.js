...
const createSchema = joi.object({
  ...
  isImportant: joi.number().integer().allow(0),
  isUrgent: joi.number().integer().allow(0),
...
let filterValidationSchema = joi.object({
  ...
  ...Object.fromEntries(keys.map(key => [key, joi.object({
    ...
    isImportant: joi.alternatives().try(joi.array().items(),joi.number().integer(),joi.object()),
    isUrgent: joi.alternatives().try(joi.array().items(),joi.number().integer(),joi.object()),
