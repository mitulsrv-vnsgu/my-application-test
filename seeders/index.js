...
async function seedUser () {
  try {
    ...
    userToBeInserted = await userDbService.findOne({ 'username':'Antonietta32' });
    if (!userToBeInserted) {  
      userToBeInserted = {
        'password':'9I33YXqFc7NIZNN',
        'isDeleted':false,
        'username':'Antonietta32',
        'email':'Brionna_Mills@hotmail.com',
        'isActive':true,
      ...
      await userDbService.update({ 'username':'Antonietta32' }, userToBeInserted);
    }
